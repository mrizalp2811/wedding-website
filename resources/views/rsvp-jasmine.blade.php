			...
			<div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
				<ul class="navbar-nav">
					...
					<li class="nav-item d-flex">
						...
						<a href="/rsvp-jasmine?lang=id" class="flag flag-icon flag-icon-id"></a>
						</div>
						<div style="padding-left: 5px; border-left: 1px solid white;">
						<a href="/rsvp-jasmine?lang=en" class="flag flag-icon flag-icon-gb"></a>
						</div>
					</li>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-12 col-md-8 align-self-center">
					<h2 class="title" style="margin-bottom: 10px;"><?php echo $lang['rsvp-title'] ?> (Jasmine)</h2>
					<div class="row">
						<div class="col-md-8 m-md-0">
							...
							<p class="d-flex align-items-center"><i class="fa fa-2x fa-clock-o align-middle pr-1"></i>16:30 - 18:30 WIB, Feb 28, 2021 </p>
							<hr class="hr-text" data-content="AND">
...
<!-- Modal -->
	...
	<script src="assets/js/google_script_jasmine.js"> </script>
</body>
