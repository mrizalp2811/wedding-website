...
<head>
		<title>Cynthia & Rizal - RSVP Rose</title>
		<meta name="robots" content="noindex">
		<meta charset=utf-8>
		<meta name=description content="Selamat datang di halaman konfirmasi kehadiran (Rose) pernikahan Cynthia dan Rizal. Kami berharap anda dapat bergabung dengan kami di hari spesial kami.">
						...
						<div class="modal-dialog modal-confirm modal-dialog-centered">
							<div class="modal-content background-modal">
								<div class="modal-body text-center" style="padding: 30px;">
									...
									<a class="btn btn-outline-dark rounded-0 px-3 py-1 font-weight-bold" href="/rsvp-rose"><span><?php echo $lang['rsvp-error-button'] ?></span></a>
								</div>
							</div>
						</div>
					</div>
